...
<span style="font-family:Arial sans-serif;font-size:16px;">WD Object Detection</span>

  
<span style="font-family:Arial sans-serif;font-size:14px;">This example shows how to use AIDetect.</span>
